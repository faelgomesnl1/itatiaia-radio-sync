...
class consolidadoDiretoriaLocalizacao {

    async listaLocalizacaoGet(req, res) {
        ...
        dados AS (
            ...
            WHERE t.id= ?  -- Filtro com o parâmetro evtId
        )
        SELECT 
            localizacao,
            ${dynamicCases}
        ...
        res.render('links/consultas/localizacao', { diretorias, colunas });
    }
}


module.exports = new consolidadoDiretoriaLocalizacao();